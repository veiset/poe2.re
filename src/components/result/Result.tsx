...
export function Result(props: ResultProps) {
  const {result, maxLength, reset} = props;
    ...
    <>
      <div className="flex">
        ...
        <div className="flex-none p-4 pb-0">
          <div>
            <Button className="m-1 round bg-green-400 hover:bg-green-600">
              <Copy/> Copy
            </Button>
      ...
      <div className={showOptions ? "p-2 bg-slate-700 flex items-center gap-2 px-4" : "hidden"}>
        ...
        <div className="flex w-full max-w-sm items-center space-x-2">
          <Input type="text" placeholder="Custom text" className="font-mono"/>
        </div>
      </div>
    </>
  )
